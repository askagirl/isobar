...
//
// Once you have a builder, you'll need update it by calling `push_dir`, `pop_dir`, and `push_file`.
...
// When we derive this implementation, the compiler thinks that Error<S> does not implemnt Debug
// in some cases.
